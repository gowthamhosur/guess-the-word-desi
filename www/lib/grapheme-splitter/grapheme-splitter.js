...
function GraphemeSplitter(){
	...
	function getGraphemeBreakProperty(code){
		...
		if(
		0x0C4D == code || // TELUGU SIGN VIRAMA
		0x094D == code || // DEVANAGIRI SIGN VIRAMA
		0x0CCD == code || // KANNADA SIGN VIRAMA
		0x0BCD == code || // TAMIL SIGN VIRAMA
		0x0D4D == code  // TAMIL SIGN VIRAMA
		){
			return Q;
		}
